...
This folder contains my SQL solutions for Week 0 of **CS50’s Introduction to Databases with SQL**, focusing on retrieving, filtering, and summarizing data across multiple datasets.
...
- **Cyberchase** – Queried a real-world dataset of TV episodes, applying filtering, ordering, and aggregation to extract insights
- **Normals** – Analyzed scientific datasets, performing numeric calculations, ranges, and averages
